													...
													<Marquee className="carouselTicker carouselTicker-right position-relative z-1" direction="right">
														<ul className="carouselTicker__list m-0">
															...
															<li className="carouselTicker__item mt-6">
																...
																<span className="tool-tip">Metasploit</span>
															</li>
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/home-page-2/hero-1/nmap.svg" alt="Nmap" />
																</Link>
																<span className="tool-tip">Nmap</span>
															</li>
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/home-page-2/hero-1/burp.svg" alt="BurpSuite" />
																</Link>
																<span className="tool-tip">BurpSuite</span>
															</li>
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/home-page-2/hero-1/nessus.svg" alt="Nessus" />
																</Link>
																<span className="tool-tip">Nessus</span>
															</li>
														</ul>
													</Marquee>
												</div>
												<div className="col-lg-8 col-md-7 col-10 mx-auto overflow-hidden">
													...
													<Marquee className="carouselTicker carouselTicker-left position-relative z-1">
														<ul className="carouselTicker__list m-0 ">
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/home-page-2/hero-1/autopsy.svg" alt="Autopsy" />
																</Link>
																<span className="tool-tip">Autopsy</span>
															</li>
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/home-page-2/hero-1/splunk.svg" alt="Splunk" />
																</Link>
																<span className="tool-tip">Splunk</span>
															</li>
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/home-page-2/hero-1/wireshark.svg" alt="Wireshark" />
																</Link>
																<span className="tool-tip">Wireshark</span>
															</li>
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/home-page-2/hero-1/tryhackme.svg" alt="TryHackMe" />
																</Link>
																<span className="tool-tip">TryHackMe</span>
															</li>
														</ul>
													</Marquee>
												</div>
														...
														<ul className="ps-3 d-flex flex-column justify-content-between h-100 position-relative">
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">Cybersecurity</p>
																	<span className="text-300">
																		Penetration Testing, Vulnerability Assessment, OWASP Top 10, Log Analysis, Identity & Access Management, Security Reporting
																	</span>
																</div>
															</li>
															...
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">Security Tools</p>
																	<span className="text-300">
																		Nmap, Burp Suite, Metasploit, Wireshark, Splunk, Autopsy, Nessus, OpenVAS, FTK Imager
																	</span>
																</div>
															</li>
															...
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">Programming & OS</p>
																	<span className="text-300">
																		Python (Basics), Bash, Linux, Windows Security
																	</span>
																</div>
															</li>
